...
function game_process(delta)
	...
	font(math_floor(player.health), 19, 124)
	local weapon_ammo
	...
	-- draw minimap
	local player_tile_x = math_floor(player.pos_x)
	local player_tile_y = math_floor(player.pos_y)
	local minimap_start_x = math_min(math_max(0, player_tile_x - 7), g_LEVEL_WIDTH - 13)
	local minimap_start_y = math_min(math_max(0, player_tile_y - 5),  g_LEVEL_HEIGHT - 10)
	for x=0,14 do
		for y=0,11 do
			local tile_val = mget(x + minimap_start_x, y + minimap_start_y)
			if tile_val ~= 0 then
				pix(199 - x, y + 122, (287 - tile_val) // 32)
			end
		end
	end
	pix(199 + minimap_start_x - player_tile_x, 122 + player_tile_y - minimap_start_y, 12)
	...
	for x=start_vline,SCREEN_WIDTH-1,step_vline do
		...
		local map_x = player_tile_x
		local map_y = player_tile_y
...
-- 204:88888888bbbbbaaab9999999b9999999b9999999b999999fa9ffffffa9ffffff
-- 205:88888888aaaaaaaa9999999999999999999999999ffff9ffffffffffffffffff
-- 206:88888888aaaaaaaa999999999999999999999999ff9ffff9ffffffffffffffff
-- 207:88888888aaaaaaa8999999a8999999a8999999a8ffff99a8fffff9a8ffff99a8
...
-- 220:a9ffffffa9ffffffa999999fa9999999a9999999a9999999aaaaaaaa88888888
-- 221:ffffffffffffffff9fffffff999999999999999999999999aaaaaaaa88888888
-- 222:ffffffffffffffffffff9999999999999999999999999999aaaaaaaa88888888
-- 223:ff9999a8999999a8999999b8999999b8999999b8999999b8aaabbbb888888888
...
-- 134:
-- 135:
-- </MAP>
