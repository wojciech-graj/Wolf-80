...
function init()
	...
	g_WEAPONS = {
		Weapon.new(204, 1e20, 107, {234, 228},      300, 250, 0  , 0.05, 2, 20, 1, 1 ),
		Weapon.new(200, 50  , 113, {234, 228},      350, 350, 0  , 0.05, 5, 15, 1, 32),
...
function pause_process(delta)
	...
	map(226, 90, 14, 12, 64, 20)
	print("Interlacing", 72, 38)
	print("Floor&Ceiling", 72, 50)
	print("Difficulty", 72, 62)
	print("Volume", 72, 74)
	print("Turn Speed", 72, 86)
	print("Debug", 72, 98)

	if btnp(0) then
		settings.selected_setting = math.max(0, settings.selected_setting - 1)
	elseif btnp(1) then
		settings.selected_setting = math.min(5, settings.selected_setting + 1)
	end
	...
	if setting_change ~= 0 then
		...
		elseif settings.selected_setting == 3 then
			settings.volume = math.min(15, math.max(0, settings.volume + setting_change * 3))
		elseif settings.selected_setting == 4 then
			settings.turn_speed = math.max(0, settings.turn_speed + setting_change * 0.001)
		else --settings.selected_setting == 5
			settings.debug = not settings.debug
		end
	end

	print(on_off[settings.interlace < 2], 148, 38)
	print(on_off[settings.floor_ceil], 148, 50)
	print(settings.volume // 3, 154, 74)
	print(math.floor(settings.turn_speed * 1000), 154, 86)
	print(on_off[settings.debug], 148, 98)

	local selected_setting_y = 36 + 12 * settings.selected_setting

	spr(317 + settings.sprite, 140, selected_setting_y, 0)
...
-- 090:
-- 091:
-- 092:
